package com.qyu.coolweather.activity;
...
import com.qyu.coolweather.R;
import com.qyu.coolweather.db.CoolWeatherDB;
import com.qyu.coolweather.model.City;
import com.qyu.coolweather.model.County;
import com.qyu.coolweather.model.Province;
import com.qyu.coolweather.util.HttpCallbackListener;
import com.qyu.coolweather.util.HttpUtil;
import com.qyu.coolweather.util.LogUtil;
import com.qyu.coolweather.util.Utility;
...
public class ChooseAreaActivity extends Activity {
    ...
    private void queryFromServer(final String code, final String type) {
        String address;
        LogUtil.w("queryFromServer", "come in!!!!!!");
        ...
        showProgressDialog();
        LogUtil.d("queryFromServer", address);
        HttpUtil.sendHttpRequest(address, new HttpCallbackListener() {
            ...
            public void onFinish(String response) {
                ...
                if (result) {
                    // 通过runOnUiThread() methor 回到主线程处理逻辑
