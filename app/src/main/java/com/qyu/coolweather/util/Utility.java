...
public class Utility {
    ...
    /**
     *  parse JSON data returned by server and the resulting save the local
     */
    public static void handleWeatherResponse(Context context, String response) {
        LogUtil.w("handleWeatherResponse", response);
        try {
    ...
    /**
     * 将服务器返回的天气信息save SharedPreferences
     */
